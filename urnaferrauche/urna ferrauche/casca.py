...
#def tocar_som():
    #pygame.mixer.music.load('D:/urna ferrauche/teclas/bip.mp3')  
    #pygame.mixer.music.play() 

def tocar_som():
    try:
        pygame.mixer.music.load('C:/urna ferrauche/teclas/bip.mp3')  
        pygame.mixer.music.play()
...
def press_key(key):
    ...
    if key == 'Confirmar':
            ve_imagem()
            pygame.mixer.music.load('C:/urna ferrauche/teclas/confirma-urna.mp3')
            pygame.mixer.music.play()
...
def ve_imagem():
    global img_label
    try:
        img = Image.open("C:/urna ferrauche/justica_eleitoral.png")
...
nums = {
    '1': 'C:/urna ferrauche/teclas/n1.png',
    '2': 'C:/urna ferrauche/teclas/n2.png',
    '3': 'C:/urna ferrauche/teclas/n3.png',
    '4': 'C:/urna ferrauche/teclas/n4.png',
    '5': 'C:/urna ferrauche/teclas/n5.png',
    '6': 'C:/urna ferrauche/teclas/n6.png',
    '7': 'C:/urna ferrauche/teclas/n7.png',
    '8': 'C:/urna ferrauche/teclas/n8.png',
    '9': 'C:/urna ferrauche/teclas/n9.png',
    '0': 'C:/urna ferrauche/teclas/n0.png',
    'Branco': 'C:/urna ferrauche/teclas/bran.png',
    'Corrigir': 'C:/urna ferrauche/teclas/corr.png',
    'Confirmar': 'C:/urna ferrauche/teclas/conf.png',
    'N': 'C:/urna ferrauche/teclas/n.png',
}
...
top_img = teclas(nums.get('top', 'C:/urna ferrauche/teclas/top-2.png'), size=(315, 130))
...
for i, row in enumerate(buttons, start=1): 
    for j, button in enumerate(row):
        ...
        if button != ' ':
            button_img = teclas(nums.get(button, 'C:/urna ferrauche/teclas/default.png'), size=(100, 70))
...
image_path_tela = 'C:/urna ferrauche/tela.png'
